...
public class DockerTestRunner {
    ...
    private static String generateHtmlContent(int total, int passed, int failed) {
        return "<!DOCTYPE html>\n" +
                ...
                "        .card { background: white; padding: 25px; border-radius: 10px; text-align: center; min-width: 150px; box-shadow: 0 4px 6px rgba(0,0,0,0.1); }\n" +
                "        .passed { border-left: 5px solid #28a745; }\n" +
                "        .failed { border-left: 5px solid #dc3545; }\n" +
                "        .total { border-left: 5px solid #007bff; }\n" +
                "        .success-rate { border-left: 5px solid #17a2b8; }\n" +
                "        .test-list { margin: 20px 0; background: white; padding: 20px; border-radius: 10px; box-shadow: 0 4px 6px rgba(0,0,0,0.1); }\n" +
                "        .test-item { padding: 15px; margin: 10px 0; border-radius: 8px; display: flex; align-items: center; }\n" +
                ...
                "        .environment { margin-top: 20px; padding: 20px; background: white; border-radius: 10px; box-shadow: 0 4px 6px rgba(0,0,0,0.1); }\n" +
                "        h1 { margin: 0; font-size: 2.5em; }\n" +
                "        h2 { color: #333; border-bottom: 2px solid #eee; padding-bottom: 10px; }\n" +
                "        h3 { margin: 0; font-size: 2em; color: #333; }\n" +
                ...
                "        <p><strong>Execution Mode:</strong> Docker Container</p>\n" +
                "        <p><strong>Java Version:</strong> Amazon Corretto 17</p>\n" +
                "    </div>\n" +
                "</body>\n" +
                "</html>";
    }
